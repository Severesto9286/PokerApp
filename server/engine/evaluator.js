...
const { rankOf, suitOf, RANK_NAMES, RANK_PLURAL } = require('./cards');
...
module.exports = { CAT, score5, evaluate, evaluateHoldem, evaluateOmaha, describe, shortName, combinations };
